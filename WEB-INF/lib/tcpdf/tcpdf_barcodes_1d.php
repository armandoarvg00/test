...
class TCPDFBarcode {
    ...
    * @param $regresa_imagen false default ,true regresa el contenido de la imagen como cadena
 	 * @return image or false in case of error.
 	 * @public
	 */
	public function getBarcodePNG($w=2, $h=30, $color=array(0,0,0), $regresa_imagen=false) {
